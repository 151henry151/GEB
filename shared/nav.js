...
(function () {
  ...
  var CHAPTERS = [
    ...
    { id: 'ch01', num: 'I', title: 'The MU-puzzle', path: '/chapter-01/', pdfPage: 42 },
    { id: 'ch02', num: 'II', title: 'Meaning and Form in Mathematics', path: '/chapter-02/', pdfPage: 55 },
    ...
    { id: 'ch13', num: 'XIII', title: 'BlooP and FlooP and GlooP', path: '/chapter-13/', pdfPage: 413 },
    ...
    { id: 'ch19', num: 'XIX', title: 'Artificial Intelligence: Prospects', path: '/chapter-19/', pdfPage: 648 },
    { id: 'ch20', num: 'XX', title: 'Strange Loops, Or Tangled Hierarchies', path: '/chapter-20/', pdfPage: 691 }
  ];
